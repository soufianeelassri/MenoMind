...
from unstructured.documents.elements import CompositeElement, Element, Table, Image
...
class PDFProcessor:
    ...
    def _process_element(self, element: Element, pdf_path, text_list, table_list, image_list):
        ...
        raw_metadata["page_number"] = element.metadata.page_number if element.metadata else None
        ...
        elif hasattr(element, "category") and element.category == "Image":
